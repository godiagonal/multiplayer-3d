...
THREEx.GrassGround	= function(opts){
	...
	var textureDiffuseUrl	= THREEx.GrassGround.baseUrl + 'grasslight-small.jpg'
	var textureDiffuse	= textureLoader.load(textureDiffuseUrl);
	...
	var textureNormalUrl	= THREEx.GrassGround.baseUrl + 'grasslight-small-nm.jpg'
	var textureNormal	= textureLoader.load(textureNormalUrl);
